...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2022 at 04:13 PM
...
INSERT INTO `criterias` (`id`, `kode`, `nama`, `bobot`, `tipe`, `created_at`, `updated_at`) VALUES
(1, 'C1', 'DCF', 3.00, 'cost', '2022-04-14 10:20:47', '2022-04-14 10:20:47');
...
(1, 'Admin', 'admin@gmail.com', NULL, '$2y$10$TjcL8RSNvEGVa3Dp8aj87OaNfq.9hGES66sk2UtEoLZDKnB5jdrka', NULL, '2022-04-14 10:20:31', '2022-04-14 10:20:31');
...
--
ALTER TABLE `subcriterias`
  ADD CONSTRAINT `subcriterias_criteria_id_foreign` FOREIGN KEY (`criteria_id`) REFERENCES `criterias` (`id`);
COMMIT;
