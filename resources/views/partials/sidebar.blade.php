        ...
        <ul class="sidebar-menu">
            ...
            @if (auth()->user()->roles == 'ADMIN')
                    ...
                    <ul class="dropdown-menu">
                        <li class="nav-item @if ($aktif == 'criteria') {{ 'active' }} @endif">
                            <a href="{{ route('criteria.index') }}" class="nav-link"><i
                                    class="fas fa-file"></i><span>Data Kriteria</span></a>
                        </li>
                        <li class="nav-item @if ($aktif == 'subcriteria') {{ 'active' }} @endif">
                            <a href="{{ route('subcriteria.index') }}" class="nav-link"><i
                                    class="fas fa-file-alt"></i><span>Data Subkriteria</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item @if ($aktif == 'siswa') {{ 'active' }} @endif">
                    <a href="{{ route('siswa.index') }}" class="nav-link"><i class="fas fa-columns"></i><span>Data
                            Siswa</span></a>
                </li>
                <li class="nav-item @if ($aktif == 'value') {{ 'active' }} @endif">
                    <a href="{{ url('penilaian.index') }}" class="nav-link"><i class="fas fa-columns"></i><span>Data
                            Penilaian</span></a>
                </li>
                ...
                <li class="nav-item @if ($aktif == 'user') {{ 'active' }} @endif">
                    <a href="{{ route('user.index') }}" class="nav-link"><i class="fas fa-users-cog"></i><span>Data
                            User</span></a>
                </li>
            @endif
