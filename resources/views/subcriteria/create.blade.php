      ...
      <div class="row">
          ...
          <div class="col-12 col-lg-6">
              <div class="form-group">
                  ...
                  <input type="number" name="nilai_subcriteria" id="nilai_subcriteria" min="1" max="5" class="form-control @error('nilai_subcriteria') is-invalid @enderror" value="{{ old('nilai_subcriteria') }}">
